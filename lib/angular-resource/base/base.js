    ...
    this.$get = ['ARAPI', 'ARCollection', 'ARAssociation', 'ARAssociations',
      ...
      function Base() {
        ...
        _this.prototype.update = function(data) {
          ...
          eventEmitter.emit('update:called', this);
          ...
          eventEmitter.emit('update:complete', this);
          return this;
        };
        ...
        _this.new = function(data) {
          ...
          _.each(associations.hasMany, function(collection) {
            var name = collection.klass.name.pluralize().downcase();
            instance[name][this.name.downcase()] = instance;
