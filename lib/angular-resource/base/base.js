angular
  ...
  .provider('ARBase', function() {
    this.$get = ['ARAPI', 'ARCollection', 'ARAssociation', 'ARAssociations',
      'AREventEmitter', 'ARValidations', '$http', '$q', 'json', '$injector',
      function(API, Collection, Association, Associations, 
        EventEmitter, Validations, $http, $q, json, $injector) {
      ...
      function Base() {
        ...
        base.$save = function(instance, url, put) {
          ...
          return $http[method](url, jsonified).then(function(response) {
        ...
        _this.prototype.$save = function(instance, url, put) {
          ...
          return base.$save(instance, url, put);
        };
        ...
        _this.prototype.$update = function(data) {
          ...
          if (data) return instance.update(data).then(function(response) {
            instance = response; 
            return finish();
          });
        ...
        function addValidations(instance) { 
          if (!instance.validates) instance.validates = {};
          ...
          Object.defineProperty(instance, 'valid', {
            get: function() { 
              return instance.validates.validate(); 
            }
          });
        ...
        Object.defineProperty(_this.prototype, 'validates', {
          enumerable: false,
           ...
           set: function(val) {
             validates = new Validations(val, this);
           }
        });
