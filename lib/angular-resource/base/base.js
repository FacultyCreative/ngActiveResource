angular
  ...
  .provider('ARBase', function() {
    this.$get = ['ARAPI', 'ARCollection', 'ARAssociation', 'ARAssociations',
      'ARHasOne', 'AREventEmitter', '$http', '$q', 'json', '$injector',
      function(API, Collection, Association, Associations, 
        HasOne, EventEmitter, $http, $q, json, $injector) {
        ...
        _this.prototype.hasOne = function(table, options) {
          ...
          if (!this[table]) {
            Object.defineProperty(this, table, {
              enumerable: false,
              configurable: true,
              value: new HasOne(association.klass, this)
            });
          }
        };
