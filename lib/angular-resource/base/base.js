    ...
    this.$get = ['ARAPI', 'ARCollection', '$http', '$q', 'json', '$rootScope', '$injector',
      ...
      function Base() {
        ...
        _this.prototype.$save = function(instance, url) {
          ...
          if (belongsTo.length) {
            var associationName = belongsTo[0].name.downcase();
            if (this[associationName]) return this[associationName].$save(instance, url);
          }
        ...
        function getBelongsToNames() {
          return _.map(belongsTo, function(klass) { return klass.name.downcase(); });
        };
        ...
        _this.prototype.belongsTo = function(table, providerArray) {
          ...
          if (providerArray) var providerName = providerArray[1];
