  ...
  .provider('ARBase', function() {
    this.$get = ['ARAPI', 'ARCollection', '$http', '$q', 'json', '$rootScope', '$injector',
      ...
      function Base() {
        ...
        function cacheInstance(instance) {
          if (instance.id) instance.constructor.cached[instance.id] = instance;
        };
        ...
        // Model#belongsTo(table)
        //
        // @param {table} - The name of the model this model belongs to.
        //
        // Stores the name of the associated model on the belongsTo variable, which the associated model
        // can access via the closure created by ActiveResource::Base.
